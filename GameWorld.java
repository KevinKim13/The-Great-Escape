...
public class GameWorld {
    ...
    public void initialize() {
        ...
        player = new Player(new ArrayList<>(), null, 0);  // Set initial room to null temporarily
    
        // Create the rooms
        Room room1 = StartingRoom.initRoom();
        player.setCurrentRoom(room1);  // Set starting room for player
        ...
        room4.setWalls(RoomFinalBossBattle.buildRoom(player));  // This is now correct!
